...
- `storage/opportunity_store.py` lines 128–133: added `ALTER TABLE outreach_attempts ADD COLUMN warm_lead_score REAL DEFAULT 0.0` migration guard in `_init_db` (try/except).
