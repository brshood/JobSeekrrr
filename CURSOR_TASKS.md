...
- Lines 128–133: added migration guard `ALTER TABLE outreach_attempts ADD COLUMN warm_lead_score REAL DEFAULT 0.0` in try/except

**engine/warm_lead.py**
- Lines 67–71: `enrich_contact_warmth` now explicitly returns `warm_lead_score` as a float clamped 0–100
