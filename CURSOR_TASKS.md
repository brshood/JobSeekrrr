...
- Line 305: added `warm_lead_score` to `upsert_outreach_attempt` fields dict

**engine/warm_lead.py**
- Lines 69–70: `enrich_contact_warmth` now clamps and returns `warm_lead_score` as `float` 0–100
