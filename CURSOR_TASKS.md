...
### Report
- `storage/opportunity_store.py`: lines 110 (`warm_lead_score` column in CREATE), 116–121 (ALTER TABLE migration guard).
- `engine/warm_lead.py`: lines 69–70 (`enrich_contact_warmth` explicit float clamp 0–100).
