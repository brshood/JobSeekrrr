...
- `storage/opportunity_store.py` lines 128–133: migration guard `ALTER TABLE outreach_attempts ADD COLUMN warm_lead_score`
- `engine/warm_lead.py` lines 69–70: `enrich_contact_warmth` returns `warm_lead_score` as float clamped 0–100
