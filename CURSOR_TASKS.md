...
### Report
- `storage/opportunity_store.py`: line 110 (added `warm_lead_score` column to CREATE TABLE), lines 116–121 (ALTER TABLE migration guard)
- `engine/warm_lead.py`: lines 69–70 (explicit float 0–100 clamp in `enrich_contact_warmth`)
