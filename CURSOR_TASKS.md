...
- `storage/opportunity_store.py` lines 116–121: added `ALTER TABLE outreach_attempts ADD COLUMN warm_lead_score` migration guard
- `engine/warm_lead.py` line 69: `warm_lead_score` explicitly cast to `float()` in `enrich_contact_warmth`
